...
public class CameraRenderer implements Renderer {
     ...
     */
    public void renderLight(GameLocation location, float radius, float[] color){
        Camera camera = this.engine.getWindow().getCurrentPanel().getCamera();
        ...
        this.engine.getRenderers().getTextureRenderer("default").applyLight(light, camera.getZoom(), camera.getAmbientLight());
    }
